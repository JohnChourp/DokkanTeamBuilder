function addCategory(categoryFilter) {
  ...
  if (element.classList.contains("checkedCategoryBtn")) {
    ...
    if (element.querySelector(".top-half-category-orange")) {
      setButtonStylesCategories(
        element,
        "#85671C",
        "#7F4503",
        "linear-gradient(180deg, #FFFFFF, #a19b95)"
      );
    }
...
function removeAllCategory() {
  const topHalfCategoryOrange = document.getElementsByClassName(
    "top-half-category-orange"
  );
  const topHalfCategoryGreen = document.getElementsByClassName(
    "top-half-category-green"
  );
  const topHalfCategoryYellow = document.getElementsByClassName(
    "top-half-category-yellow"
  );
  const topHalfCategoryCyan = document.getElementsByClassName(
    "top-half-category-cyan"
  );
  const topHalfCategoryBlue = document.getElementsByClassName(
    "top-half-category-blue"
  );
  const topHalfCategoryPurple = document.getElementsByClassName(
    "top-half-category-purple"
  );
  const topHalfCategoryRoze = document.getElementsByClassName(
    "top-half-category-roze"
  );
  const topHalfCategoryDarkGreen = document.getElementsByClassName(
    "top-half-category-dark-green"
  );
  const topHalfCategoryDarkBlue = document.getElementsByClassName(
    "top-half-category-dark-blue"
  );
  ...
  for (let i = 0; i < topHalfCategoryOrange.length; i++) {
    document
      .getElementById(filterCategory[i])
      .classList.remove("checkedCategoryBtn");
    document
      .getElementById(filterCategory[i])
      .children.item(0).style.backgroundColor = "#85671C";
    document
      .getElementById(filterCategory[i])
      .children.item(1).style.backgroundColor = "#7F4503";
    document
      .getElementById(filterCategory[i])
  ...
  for (
    let i = topHalfCategoryOrange.length;
    i < topHalfCategoryOrange.length + topHalfCategoryGreen.length;
    i++
  ) {
    document
      .getElementById(filterCategory[i])
    ...
    document
      .getElementById(filterCategory[i])
      .children.item(0).style.backgroundColor = "#51741F";
    document
      .getElementById(filterCategory[i])
      .children.item(1).style.backgroundColor = "#2F5510";
    document
      .getElementById(filterCategory[i])
      .children.item(8).style.backgroundImage =
      "linear-gradient(180deg, #FFFFFF, #a19b95)";
  ...
  for (
    let i = topHalfCategoryOrange.length + topHalfCategoryGreen.length;
    i <
    topHalfCategoryOrange.length +
      topHalfCategoryGreen.length +
      topHalfCategoryYellow.length;
    i++
  ) {
    document
      .getElementById(filterCategory[i])
    ...
    document
      .getElementById(filterCategory[i])
      .children.item(0).style.backgroundColor = "#868131";
    document
      .getElementById(filterCategory[i])
      .children.item(1).style.backgroundColor = "#7E6C06";
    document
      .getElementById(filterCategory[i])
      .children.item(8).style.backgroundImage =
      "linear-gradient(180deg, #FFFFFF, #a19b95)";
  ...
  for (
    ...
    document
      .getElementById(filterCategory[i])
      .children.item(0).style.backgroundColor = "#136B73";
    document
      .getElementById(filterCategory[i])
      .children.item(1).style.backgroundColor = "#105B59";
    document
      .getElementById(filterCategory[i])
      .children.item(8).style.backgroundImage =
      "linear-gradient(180deg, #FFFFFF, #a19b95)";
  ...
  for (
    ...
    document
      .getElementById(filterCategory[i])
      .children.item(0).style.backgroundColor = "#0F6089";
    document
      .getElementById(filterCategory[i])
      .children.item(1).style.backgroundColor = "#053C7C";
    document
      .getElementById(filterCategory[i])
      .children.item(8).style.backgroundImage =
      "linear-gradient(180deg, #FFFFFF, #a19b95)";
  ...
  for (
    ...
    document
      .getElementById(filterCategory[i])
      .children.item(0).style.backgroundColor = "#6C5087";
    document
      .getElementById(filterCategory[i])
      .children.item(1).style.backgroundColor = "#513474";
    document
      .getElementById(filterCategory[i])
      .children.item(8).style.backgroundImage =
      "linear-gradient(180deg, #FFFFFF, #a19b95)";
  ...
  for (
    ...
    document
      .getElementById(filterCategory[i])
      .children.item(0).style.backgroundColor = "#83445A";
    document
      .getElementById(filterCategory[i])
      .children.item(1).style.backgroundColor = "#742133";
    document
      .getElementById(filterCategory[i])
      .children.item(8).style.backgroundImage =
      "linear-gradient(180deg, #FFFFFF, #a19b95)";
  ...
  for (
    ...
    topHalfCategoryOrange.length +
      ...
      topHalfCategoryPurple.length +
      topHalfCategoryRoze.length +
      topHalfCategoryDarkGreen.length;
    i++
  ) {
    document
      .getElementById(filterCategory[i])
    ...
    document
      .getElementById(filterCategory[i])
      .children.item(0).style.backgroundColor = "#105E4B";
    document
      .getElementById(filterCategory[i])
      .children.item(1).style.backgroundColor = "#073F2B";
    document
      .getElementById(filterCategory[i])
      .children.item(8).style.backgroundImage =
      "linear-gradient(180deg, #FFFFFF, #a19b95)";
  ...
  for (
    ...
    topHalfCategoryOrange.length +
      ...
      topHalfCategoryRoze.length +
      topHalfCategoryDarkGreen.length +
      topHalfCategoryDarkBlue.length;
    i++
  ) {
    document
      .getElementById(filterCategory[i])
    ...
    document
      .getElementById(filterCategory[i])
      .children.item(0).style.backgroundColor = "#29355B";
    document
      .getElementById(filterCategory[i])
      .children.item(1).style.backgroundColor = "#0A093C";
    document
      .getElementById(filterCategory[i])
      .children.item(8).style.backgroundImage =
      "linear-gradient(180deg, #FFFFFF, #a19b95)";
  }
  let filterCategoryContainerTextFirst = document.getElementsByClassName(
    "filter-category-container-text-first"
  );
...
function closeCategoriesSelectBtn() {
  ...
  if (filterCategoryUsed.length > 1) {
    setButtonStylesCategories(
      ...
      "#57C75B",
      "#199411",
      "linear-gradient(rgb(255, 255, 255), rgb(219, 206, 189))"
    );
    filterCategoryContainerTextFirst.item(0).innerHTML =
