function filterSuperAttackType(id) {
  ...
  const btnImg = document.getElementById(
    "filter_super_attack_type_" + id + "-image-id"
  );
...
function removeAllSuperAttackType() {
  ...
  const elements = filterSuperAttackTypeId.map((id) =>
