function filtersMultipleUsedWithSearchChar(
  dataChars, filtersEachLengthString, filtersEachLengthStringUsed,
  filtersUsed, dataCharNameOrTitleItems, dataCharNameOrTitle,
  characterSearchId) {
  ...
  characterSearchId.addEventListener("keypress", function (event) {
    if (event.key === "Enter") {
      ...
      const dataCharTitle = "data-char-title", dataCharName = "data-char-name",
        dataCharCategories = "data-char-categories", dataCharRarity = "data-char-rarity",
      ...
      const dataChars = [
        dataCharCategories, dataCharRarity, dataCharType,
      ...
      //checked filter Btn
      const filterClasses = [
        "checkedCategoryBtn", "checkedRarityBtn", "checkedTypeBtn",
        "checkedClassBtn", "checkedAwakenBtn", "checkedSuperAttackTypeBtn",
        "checkedEzaBtn", "checkedRecruitBtn",
      ];
      ...
      if (sumFilterUsed == 0) {
        for (let i = 0; i < char.length; i++) {
          if (
            dataCharNameOrTitleItems[i]
              .getAttribute(dataCharNameOrTitle)
              .toLowerCase()
              .indexOf(characterSearchId.value.toLowerCase()) >= 0
          ) {
      ...
      if (sumFilterUsed > 0) {
        charListDefault = filtersMultipleUsedWithSearchChar(
          dataChars, filtersEachLengthString, filtersEachLengthStringUsed,
          filtersUsed, dataCharNameOrTitleItems, dataCharNameOrTitle,
          characterSearchId
        );
