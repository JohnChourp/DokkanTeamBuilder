function deviceWidthAndHeight() {
  ...
  document.getElementById("test-device-id").innerHTML =
    "width device:" + widthDevice + "height device:" + heighthDevice;
  {
...
function windowWidthAndHeight() {
  ...
  document.getElementById("test-window-id").innerHTML =
    "width window:" + widthWindow + "height window:" + heighthWindow;
  {
